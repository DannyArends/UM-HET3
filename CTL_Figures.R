...
for(i in 1:length(all)){
  ...
  setwd("/home/rqdt9/Dropbox (UTHSC GGI)/ITP_HET3_Mapping_Paper_Arends_2021/00_ITP_BioRxiv_All_Key_Files/11_FiguresRedone/CTL")
  pdf(paste0("Figure_3_CTL_",names(all)[i],".pdf"), width = 36, height = 12)
  op <- par(mfrow = c(1,3))
  par(cex=1.5)
  par(cex.axis=1.2)

    plot(c(22.5, 47.5), c(400, 1100), t = "n", xlab = "Adjusted bodyweight (6mo)", ylab = "Adjusted longevity", 
