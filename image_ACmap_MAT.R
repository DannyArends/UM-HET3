...
#
# Progressive lifespan QTL mapping visualization on maternal map
#
...
lods.m.All <- read.table("progressiveMapping_mat_males.txt", sep = "\t", check.names=FALSE)
lods.m.All <- lods.m.All[c(TRUE,FALSE,FALSE), ]
lods.f.All <- read.table("progressiveMapping_mat_females.txt", sep = "\t", check.names=FALSE)
lods.f.All <- lods.f.All[c(TRUE,FALSE,FALSE), ]
lods.c.All <- read.table("progressiveMapping_mat_all.txt", sep = "\t", check.names=FALSE)
