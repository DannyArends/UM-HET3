...
# We don't use 4 genotype probabilities at each marker, but use maternal haplotypes (A and B)
#
...
write.table(round(lods.cM,2), "DataSet/output/progressiveMapping_mat_all.txt", sep = "\t", quote=FALSE)
...
write.table(round(lods.fM,2), "DataSet/output/progressiveMapping_mat_females.txt", sep = "\t", quote=FALSE)
...
write.table(round(lods.mM,2), "DataSet/output/progressiveMapping_mat_males.txt", sep = "\t", quote=FALSE)
