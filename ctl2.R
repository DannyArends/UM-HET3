...
setwd("/home/rqdt9/Dropbox (UTHSC GGI)/ITP_HET3_Mapping_Paper_Arends_2021/00_ITP_BioRxiv_All_Key_Files/04_CTL_and_Epistasis_Figure")
#pdf(paste0("Figure_3_CTL_mapping_v3.pdf"), width = 36, height = 12)
par(cex=2)
par(cex.axis=1.5)
